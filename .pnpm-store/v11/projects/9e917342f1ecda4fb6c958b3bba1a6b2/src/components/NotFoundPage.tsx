    ...
    <section className="w-full max-w-xl text-center">
      ...
      <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-xs font-bold text-white transition hover:bg-blue-500"
        >
        ...
        <button
          type="button"
          onClick={onGoHome}
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-800 bg-slate-900/50 px-5 py-3 text-xs font-bold text-slate-300 transition hover:border-slate-700 hover:text-white"
        >
